...
*
**/
Easy2DCamera = function (canvas , spaceInfo , scrolling )
{
	...
	{
		if( scrollingValues.left.active && returnDistance >= scrollingValues.left.min*3 && pos.x <= spaceInfos.pointReferenceX - scrollingValues.left.min )
			spaceInfos.worldX -= spaceInfos.myTarget.speed*scrollingValues.speed;
		else if( scrollingValues.left.active && returnDistance >= scrollingValues.left.min && pos.x <= spaceInfos.pointReferenceX - scrollingValues.left.min )
			spaceInfos.worldX -= scrollingValues.speed;
		if( scrollingValues.right.active && returnDistance >= scrollingValues.right.min*3 && pos.x >= spaceInfos.pointReferenceX + scrollingValues.right.min )
			spaceInfos.worldX += spaceInfos.myTarget.speed*scrollingValues.speed;
		else if( scrollingValues.right.active && returnDistance >= scrollingValues.right.min && pos.x >= spaceInfos.pointReferenceX + scrollingValues.right.min)
			spaceInfos.worldX += scrollingValues.speed;
		...
		else if( scrollingValues.up.active && returnDistance >= scrollingValues.up.min && pos.y <= spaceInfos.pointReferenceY - scrollingValues.up.min)
		...
		if( scrollingValues.down.active && returnDistance >= scrollingValues.down.min*3 && pos.y >= spaceInfos.pointReferenceY + scrollingValues.down.min) 
			spaceInfos.worldY += spaceInfos.myTarget.speed*scrollingValues.speed;
		else if( scrollingValues.down.active && returnDistance >= scrollingValues.down.min && pos.y >= spaceInfos.pointReferenceY + scrollingValues.down.min) 
			spaceInfos.worldY += scrollingValues.speed;
	};
